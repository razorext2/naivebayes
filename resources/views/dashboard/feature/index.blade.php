<x-layouts::app :title="__('Dashboard')">
    <div class="flex h-full w-full flex-1 flex-col gap-4 rounded-xl">
        ...
        <flux:heading size="xl">Daftar Fitur Algoritma</flux:heading>
        ...
        <div class="flex items-center justify-start">
            <flux:button href="{{ route('feature.create') }}" wire:navigate icon="plus" variant="primary" color="green">
                Tambah Fitur
            </flux:button>
        </div>
